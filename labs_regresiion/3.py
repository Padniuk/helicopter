...
if __name__ == '__main__':
    X0 = [1 for k in range(5)]
    X1 = [rn.choice(range(x1min,x1max)) for k in range(5)]
    X2 = [rn.choice(range(x2min,x2max)) for k in range(5)]
    X3 = [rn.choice(range(x3min,x3max)) for k in range(5)]     
    ...
    while True:
        ...
        while True:
            Yy = []
            for i in range(m): 
                Yy.append([rn.choice(range(ymin,ymax)) for k in range(5)])
