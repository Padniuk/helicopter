...
if __name__ == '__main__':
    ...
    -1.73*dx[0]+x0[0],1.73*dx[0]+x0[0],x0[0],x0[0],x0[0],x0[0],x0[0]]
    X2 = [x2min,x2min,x2max,x2max,x2min,x2min,x2max,x2max,\
    x0[1],x0[1],-1.73*dx[1]+x0[1],1.73*dx[1]+x0[1],x0[1],x0[1],x0[1]]
    X3 = [x3min,x3max,x3min,x3max,x3min,x3max,x3min,x3max,\
    x0[2],x0[2],x0[2],x0[2],-1.73*dx[2]+x0[2],1.73*dx[2]+x0[2],x0[2]]
